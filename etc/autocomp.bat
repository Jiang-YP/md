...
echo Processing d1mach.f        ... [04/10]: Subroutine for machine number, invoked by integal solver
call aspcomp d1mach.f
call aspcomp i1mach.f 
echo Processing dqk15.f         ... [05/10]: Integal solver
call aspcomp dqk15.f
echo Processing diff.f          ... [06/10]: Deriviation solver
call aspcomp diff.f
echo Processing property.f90    ... [07/10]: Subroutines of physical properties
call aspcomp property.f90
echo Processing localflux.f90   ... [08/10]: Subroutine for local heat and mass transfer rates
